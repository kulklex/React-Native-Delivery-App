    ...
    <View className="bg-[#00CC88] flex-1">
      ...
      >
        <Marker 
            ...
            title={restaurant.title} description={restaurant.short_description}
            identifier='origin' pinColor='#00CC88'
         />
      </MapView>
      ...
      <SafeAreaView className="bg-white flex-row items-center space-x-5 h-28">
        ...
        <View className="flex-1">
            <Text className="text-lg">Dan Stones</Text>
            <Text className="text-gray-400">Your Rider</Text>
        </View>
        <View className="mr-5 flex-row items-center space-x-1">
            <PhoneIcon size={25} color="#00CC88" />
        </View>
      </SafeAreaView>
    </View>
  )
